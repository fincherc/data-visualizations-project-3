...
An ethical concern tied to public safety and awareness is the lack of public awareness regarding the increased dangers posed by specific weather conditions (e.g., rain, fog, thunderstorms) can contribute to accidents. Vulnerable populations, such as new drivers or those unfamiliar with certain areas, may be disproportionately affected. Austin, TX compared to other places has pretty decent weather. So, the fact that weather conditions are effecting accidents here shows that other places really need to take extra caution. 
